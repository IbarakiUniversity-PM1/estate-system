...
echo $this->Form->input('preview_date_1', array('dateFormat' => 'MD', 'maxYear' => date('Y'), 'minYear' => date('Y') - 100, 'monthNames' => false, 'label' => array('text' => '第一希望日')));
echo $this->Form->input('preview_date_2', array('dateFormat' => 'MD', 'maxYear' => date('Y'), 'minYear' => date('Y') - 100, 'monthNames' => false, 'label' => array('text' => '第一希望日')));
echo $this->Form->input('preview_date_3', array('dateFormat' => 'MD', 'maxYear' => date('Y'), 'minYear' => date('Y') - 100, 'monthNames' => false, 'label' => array('text' => '第一希望日')));
